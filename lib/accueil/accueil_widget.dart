                    ...
                    children: [
                      ...
                      StreamBuilder<List<MissionRecord>>(
                        stream: queryMissionRecord(
                          queryBuilder: (missionRecord) => missionRecord
                                          ...
                                          Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 8.0, 0.0, 0.0),
                                            child: Text(
                                              scrollPaddingMissionRecord.titre,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
                        ...
                        child: StreamBuilder<List<AnnonceRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final columnAnnonceRecord =
                                columnAnnonceRecordList.isNotEmpty
                                    ? columnAnnonceRecordList.first
                                    : null;
                            return Column(
                              mainAxisSize: MainAxisSize.max,
                              children: [
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed('ListeAnnonce');
                                    },
                                    child: Container(
                                      width: double.infinity,
                                      height: 60.0,
                      ...
                      Padding(
                        ...
                        child: StreamBuilder<List<RessourceRecord>>(
                          stream: queryRessourceRecord(
                            queryBuilder: (ressourceRecord) => ressourceRecord
                      ...
                      if (valueOrDefault(currentUserDocument?.role, '') ==
                        ...
                        Padding(
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) =>
                                StreamBuilder<List<NoteAssociationRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<NoteAssociationRecord>
                                    columnNoteAssociationRecordList =
                                    snapshot.data!;
                                // Return an empty Container when the item does not exist.
                                if (snapshot.data!.isEmpty) {
                                  return Container();
                                ...
                                final columnNoteAssociationRecord =
                                    columnNoteAssociationRecordList.isNotEmpty
                                        ? columnNoteAssociationRecordList.first
                                        : null;
                                return InkWell(
                                  splashColor: Colors.transparent,
                                  focusColor: Colors.transparent,
                      ...
                      if (valueOrDefault(currentUserDocument?.role, '') ==
                        ...
                        Padding(
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) =>
                                StreamBuilder<List<NoteEducateurRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final columnNoteEducateurRecord =
                                    columnNoteEducateurRecordList.isNotEmpty
                                        ? columnNoteEducateurRecordList.first
                                        : null;
                                return InkWell(
                                  splashColor: Colors.transparent,
                                  focusColor: Colors.transparent,
                        ...
                        child: StreamBuilder<List<MaisonRecord>>(
                          stream: queryMaisonRecord(
                            queryBuilder: (maisonRecord) =>
                                maisonRecord.orderBy('age', descending: true),
                            singleRecord: true,
                          ),
                          builder: (context, snapshot) {
                            // Customize what your widget looks like when it's loading.
                            ...
                            List<MaisonRecord> columnMaisonRecordList =
                                snapshot.data!;
                            // Return an empty Container when the item does not exist.
                            if (snapshot.data!.isEmpty) {
                              return Container();
                            }
                            final columnMaisonRecord =
                                columnMaisonRecordList.isNotEmpty
                                            ...
                                            ClipRRect(
                                              ...
                                              child: Image.network(
                                                valueOrDefault<String>(
                                                  columnMaisonRecord
                                                      ?.imageMaison,
                                                  'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/app-remus-vo7cob/assets/npr242is1tc1/WhatsApp_Image_2024-03-18_at_18.43.29_(1).jpeg',
                                                ),
                                                width: 100.0,
                                                fit: BoxFit.cover,
                                              ),
