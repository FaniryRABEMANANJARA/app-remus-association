...
import 'modification_profil_model.dart';
export 'modification_profil_model.dart';

class ModificationProfilWidget extends StatefulWidget {
  const ModificationProfilWidget({
    super.key,
    required this.detailProfil,
  });

  final DocumentReference? detailProfil;

  @override
  State<ModificationProfilWidget> createState() =>
      _ModificationProfilWidgetState();
}

class _ModificationProfilWidgetState extends State<ModificationProfilWidget> {
  late ModificationProfilModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModificationProfilModel());
    ...
    _model.prenomTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.prenoms, ''));
    ...
    _model.informationPersoTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.informationPerso, ''));
    _model.informationPersoFocusNode ??= FocusNode();

    _model.informationMedTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.informationMed, ''));
    _model.informationMedFocusNode ??= FocusNode();

    _model.numSiretTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.numSIRET, ''));
    _model.numSiretFocusNode ??= FocusNode();
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: AuthUserStreamWidget(
                      builder: (context) => TextFormField(
                        controller: _model.numSiretTextController,
                        focusNode: _model.numSiretFocusNode,
                        textCapitalization: TextCapitalization.words,
                        obscureText: false,
                        decoration: InputDecoration(
                        ...
                        validator: _model.numSiretTextControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ),
                    ...
                    child: AuthUserStreamWidget(
                      builder: (context) => FlutterFlowDropDown<String>(
                        controller: _model.sexeValueController ??=
                          ...
                          _model.sexeValue ??=
                              valueOrDefault(currentUserDocument?.sexe, ''),
                        ),
                      ...
                      builder: (context) => FlutterFlowDropDown<String>(
                        controller: _model.vehiculeValueController ??=
                          ...
                          _model.vehiculeValue ??=
                              valueOrDefault(currentUserDocument?.vehicule, ''),
                        ),
                    ...
                    child: AuthUserStreamWidget(
                      builder: (context) => FlutterFlowDropDown<String>(
                        controller: _model.autoEntrepreneurValueController ??=
                            FormFieldController<String>(
                          _model.autoEntrepreneurValue ??= valueOrDefault(
                              currentUserDocument?.autoEntrepreneur, ''),
                        ),
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await currentUserReference!
                            ...
                            numSIRET: _model.numSiretTextController.text,
