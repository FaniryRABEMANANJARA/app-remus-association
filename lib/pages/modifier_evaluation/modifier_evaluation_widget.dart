...
class ModifierEvaluationWidget extends StatefulWidget {
  const ModifierEvaluationWidget({
    super.key,
    required this.modifEvaluation,
  });

  final NoteAssociationRecord? modifEvaluation;

  @override
  State<ModifierEvaluationWidget> createState() =>
      _ModifierEvaluationWidgetState();
}

class _ModifierEvaluationWidgetState extends State<ModifierEvaluationWidget>
    with TickerProviderStateMixin {
  late ModifierEvaluationModel _model;
          ...
          child: Padding(
            ...
            child: StreamBuilder<List<NoteAssociationRecord>>(
              ...
              builder: (context, snapshot) {
                ...
                List<NoteAssociationRecord>
                    scrollingColumnNoteAssociationRecordList = snapshot.data!;
                // Return an empty Container when the item does not exist.
                if (snapshot.data!.isEmpty) {
                  return Container();
                }
                final scrollingColumnNoteAssociationRecord =
                    scrollingColumnNoteAssociationRecordList.isNotEmpty
                        ? scrollingColumnNoteAssociationRecordList.first
                        : null;
