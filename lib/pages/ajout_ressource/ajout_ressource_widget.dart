...
class AjoutRessourceWidget extends StatefulWidget {
  const AjoutRessourceWidget({super.key});

  @override
  State<AjoutRessourceWidget> createState() => _AjoutRessourceWidgetState();
}

class _AjoutRessourceWidgetState extends State<AjoutRessourceWidget> {
  late AjoutRessourceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AjoutRessourceModel());
