...
class AuthLoginAssociationWidget extends StatefulWidget {
  const AuthLoginAssociationWidget({super.key});

  @override
  State<AuthLoginAssociationWidget> createState() =>
      _AuthLoginAssociationWidgetState();
}

class _AuthLoginAssociationWidgetState extends State<AuthLoginAssociationWidget>
    with TickerProviderStateMixin {
  late AuthLoginAssociationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuthLoginAssociationModel());
    ...
    _model.maisonController ??= TextEditingController();
    _model.maisonFocusNode ??= FocusNode();
