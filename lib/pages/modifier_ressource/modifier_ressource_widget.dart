...
class ModifierRessourceWidget extends StatefulWidget {
  const ModifierRessourceWidget({
    super.key,
    required this.modifierRessource,
  });

  final RessourceRecord? modifierRessource;

  @override
  State<ModifierRessourceWidget> createState() =>
      _ModifierRessourceWidgetState();
}

class _ModifierRessourceWidgetState extends State<ModifierRessourceWidget> {
  late ModifierRessourceModel _model;
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Form(
            ...
            child: StreamBuilder<RessourceRecord>(
              stream: RessourceRecord.getDocument(
                  widget.modifierRessource!.reference),
              builder: (context, snapshot) {
                ...
                final columnRessourceRecord = snapshot.data!;
                return Column(
                  mainAxisSize: MainAxisSize.max,
