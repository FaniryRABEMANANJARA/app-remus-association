                ...
                children: [
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                FFButtonWidget(
                                  onPressed: () async {
                                    context.pushNamed('Auth_Login_Association');
                                  },
                                  text: 'Association',
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                context.pushNamed('Auth_Login_Educateur');
                              },
                              text: 'Éducateur',
                              options: FFButtonOptions(
                                height: 48.0,
                  ...
                  StreamBuilder<List<MissionRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<MissionRecord> scrollPaddingMissionRecordList =
                          snapshot.data!;
                      return SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: List.generate(
                              scrollPaddingMissionRecordList.length,
                              (scrollPaddingIndex) {
                            final scrollPaddingMissionRecord =
                  ...
                  Padding(
                    ...
                    child: StreamBuilder<List<AnnonceRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<AnnonceRecord> columnAnnonceRecordList =
                            snapshot.data!;
                        return Column(
                          mainAxisSize: MainAxisSize.max,
                          children: List.generate(
                              columnAnnonceRecordList.length, (columnIndex) {
