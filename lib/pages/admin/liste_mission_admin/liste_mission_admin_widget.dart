...
import 'liste_mission_admin_model.dart';
export 'liste_mission_admin_model.dart';

class ListeMissionAdminWidget extends StatefulWidget {
  const ListeMissionAdminWidget({super.key});

  @override
  State<ListeMissionAdminWidget> createState() =>
      _ListeMissionAdminWidgetState();
}

class _ListeMissionAdminWidgetState extends State<ListeMissionAdminWidget> {
  late ListeMissionAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListeMissionAdminModel());
  }
