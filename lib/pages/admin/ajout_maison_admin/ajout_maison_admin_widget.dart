...
import 'ajout_maison_admin_model.dart';
export 'ajout_maison_admin_model.dart';

class AjoutMaisonAdminWidget extends StatefulWidget {
  const AjoutMaisonAdminWidget({super.key});

  @override
  State<AjoutMaisonAdminWidget> createState() => _AjoutMaisonAdminWidgetState();
}

class _AjoutMaisonAdminWidgetState extends State<AjoutMaisonAdminWidget> {
  late AjoutMaisonAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AjoutMaisonAdminModel());
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          await MaisonRecord.collection
                                              .doc()
                                              .set(createMaisonRecordData(
                                                nom: _model.nomController.text,
                                                tauxHoraire: _model
                                                    .tauxHoraireController.text,
                                                imageMaison:
                                                    _model.uploadedFileUrl,
                                                description: _model
