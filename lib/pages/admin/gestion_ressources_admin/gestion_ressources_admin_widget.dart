...
import 'gestion_ressources_admin_model.dart';
export 'gestion_ressources_admin_model.dart';

class GestionRessourcesAdminWidget extends StatefulWidget {
  const GestionRessourcesAdminWidget({super.key});

  @override
  State<GestionRessourcesAdminWidget> createState() =>
      _GestionRessourcesAdminWidgetState();
}

class _GestionRessourcesAdminWidgetState
    extends State<GestionRessourcesAdminWidget> {
  late GestionRessourcesAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GestionRessourcesAdminModel());
  }
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    context.pushNamed('AjoutRessource_Admin');
                                  },
                                ),
                              ],
                            ),
