...
import 'liste_ressources_model.dart';
export 'liste_ressources_model.dart';

class ListeRessourcesWidget extends StatefulWidget {
  const ListeRessourcesWidget({super.key});

  @override
  State<ListeRessourcesWidget> createState() => _ListeRessourcesWidgetState();
}

class _ListeRessourcesWidgetState extends State<ListeRessourcesWidget> {
  late ListeRessourcesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListeRessourcesModel());
  }
