...
class CodeValidationWidget extends StatefulWidget {
  const CodeValidationWidget({super.key});

  @override
  State<CodeValidationWidget> createState() => _CodeValidationWidgetState();
}

class _CodeValidationWidgetState extends State<CodeValidationWidget> {
  late CodeValidationModel _model;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> codeValidationUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final codeValidationUsersRecord =
            codeValidationUsersRecordList.isNotEmpty
                ? codeValidationUsersRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).primaryBackground,
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: 'Entrer votre code d\'activation....',
