...
import 'ajout_evaluation_model.dart';
export 'ajout_evaluation_model.dart';

class AjoutEvaluationWidget extends StatefulWidget {
  const AjoutEvaluationWidget({super.key});

  @override
  State<AjoutEvaluationWidget> createState() => _AjoutEvaluationWidgetState();
}

class _AjoutEvaluationWidgetState extends State<AjoutEvaluationWidget>
    with TickerProviderStateMixin {
  late AjoutEvaluationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AjoutEvaluationModel());

    _model.nomEducateurController ??= TextEditingController();
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        FFButtonWidget(
                          onPressed: () async {
                            await NoteAssociationRecord.collection
                                .doc()
                                .set(createNoteAssociationRecordData(
                                  commentaire:
                            ...
                            context.pushNamed('ListeNote_Educateur');
                          },
                          text: 'Valider',
