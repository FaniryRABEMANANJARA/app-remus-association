...
class AjoutMaisonWidget extends StatefulWidget {
  const AjoutMaisonWidget({super.key});

  @override
  State<AjoutMaisonWidget> createState() => _AjoutMaisonWidgetState();
}

class _AjoutMaisonWidgetState extends State<AjoutMaisonWidget> {
  late AjoutMaisonModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AjoutMaisonModel());
