...
class EvaluationWidget extends StatefulWidget {
  const EvaluationWidget({super.key});
...
class _EvaluationWidgetState extends State<EvaluationWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EvaluationModel());
  }
                  ...
                  child: StreamBuilder<List<NoteAssociationRecord>>(
                    stream: queryNoteAssociationRecord(
                      queryBuilder: (noteAssociationRecord) =>
                          noteAssociationRecord.orderBy('note',
                              descending: true),
                    ),
                    builder: (context, snapshot) {
                      ...
                      List<NoteAssociationRecord>
                          columnNoteAssociationRecordList = snapshot.data!;
                      return Column(
                        mainAxisSize: MainAxisSize.max,
                        children: List.generate(
                            columnNoteAssociationRecordList.length,
                            (columnIndex) {
                                      ...
                                      Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: Image.network(
                                              'https://images.unsplash.com/photo-1506033907656-eae676f6ed7e?w=1280&h=720',
                                              width: 44.0,
                                              height: 44.0,
                                              fit: BoxFit.cover,
                                            ),
                                                ...
                                                children: [
                                                  ...
                                                  InkWell(
                                                    ...
                                                    highlightColor:
                                                        Colors.transparent,
                                                    onTap: () async {
                                                      await columnNoteAssociationRecord
                                                          .reference
                                                          .delete();
                                                    },
                                                    child: Icon(
